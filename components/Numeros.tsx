...
const metrics = [
  { value: 133,  prefix: "",   suffix: "",    label: "Puntos de venta relevados",      sub: "En Entre Ríos, activos hoy" },
  { value: 16,   prefix: "",   suffix: "",    label: "Ciudades cubiertas",              sub: "Y creciendo cada semana" },
  { value: 500,  prefix: "+",  suffix: "",    label: "Fotos verificadas por IA",        sub: "Triple validación automática" },
  { value: 100,  prefix: "",   suffix: "%",   label: "Tasa de aprobación promedio",     sub: "Los vendedores no hacen doble trabajo" },
  { value: 48,   prefix: "<",  suffix: "hs",  label: "Hasta los primeros datos",        sub: "Campaña activa en 24hs" },
  { value: 200,  prefix: "",   suffix: " pts",label: "Por foto aprobada",               sub: "El vendedor gana mientras trabaja" },
];
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1.25rem" }}>
          {metrics.map((m, i) => (
            <div key={i} className="card blur-in" style={{
              ...
              <p style={{ color: "var(--text)", fontWeight: 600, fontSize: "0.88rem", marginTop: 8, marginBottom: 4 }}>{m.label}</p>
              <p style={{ color: "var(--text-muted)", fontSize: "0.78rem", lineHeight: 1.4 }}>{m.sub}</p>
            </div>
          ))}
        </div>
